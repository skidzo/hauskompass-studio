...
- runtime-referenced planning evidence docs
- `CURRENT_STATE.md`
- Codex handoff state files
- the asset data model used by the renovation seed
- the generated showcase PDF used by export tooling
