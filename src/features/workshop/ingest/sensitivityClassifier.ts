/**
 * Automatic sensitivity classification for ingested assets.
 *
 ...
 *  9. Fallback → 'internal'
 *
 * GPS-Exif detection is not done here (requires full EXIF parsing library).
 * Instead, the caller can flag GPS presence separately.
 */

import type { SensitivityLevel } from '@/domain/workshop/types';
...
export function classifyAssetSensitivity(
    ...
    if (mime.startsWith('image/')) {
        ...
        // Default: photos are internal (may contain persons/location)
