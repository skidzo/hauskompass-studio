...
Usage (from project root):
    python utils/download_lgl_bw_lod2.py 509_5396
    python utils/download_lgl_bw_lod2.py 509 5396
    python utils/download_lgl_bw_lod2.py --address "Büsnauer Str. 29, 70563 Stuttgart"
...
CACHE_DIR = os.path.join(os.path.dirname(__file__), "..", "cache", "lgl-bw", "lod2")
