#!/usr/bin/env node
/**
 * inspect_seed.mjs — Developer inspection utility for Eiermann Campus seed data.
 *
 * Usage (from project root):
 *   node utils/inspect_seed.mjs
 *   node utils/inspect_seed.mjs --json        # print full bundle as JSON
 *   node utils/inspect_seed.mjs --zone z-parkdeck-1
 */
...
const EXAMPLES = resolve(ROOT, 'examples', 'eiermann');
...
// ── overview ─────────────────────────────────────────────────────────────────
h1('Eiermann Campus — Seed Inspection');
